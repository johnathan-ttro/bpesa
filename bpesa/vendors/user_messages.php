...
$inboxContentSql = "SELECT pageContent FROM vendorpages WHERE pageUrl = '" . $currentpage . "'";
...
//page Content
echo '<h1 class="page-title"><span class="current-page">Mes</span>sages</h1>' . $inboxContent . '<br /><br />';
//message Lists
