...
echo '</table>
      ...
      <div id="showFormButton">
        <h2><span class="selectors text-center">Reply</span></h2>
        <h2><a href="' .   HOSTNAME . 'users/user_messages.php"><span class="selectors text-center">Back</span></a></h2>
      </div>
      <br />
      ...
      <form name="replyForm" action="' . HOSTNAME . 'functions/message_send.php" method="post" onsubmit="return validateReplyForm()">
        ...
        <input type="hidden" name="currentPageType" value="users">
        <br/>
