...
<div class="navbar navbar-default navbar-static-top" style="" role="navigation">
  <div style="position:relative" class="desktop-head"> <img class="menu-icon" src="menu_sml.png" data-toggle="collapse" data-target="#menu" style="position:absolute; z-index:10;"> <img src="header2.png" style="position:relative; width:100%; max-height:126px;max-width:960px;" class="img-responsive"> </div>
  <div style="position:relative;" class="mobile-head"> <img src="header_sml.png" style="position:relative; width:100%; max-height:126px;max-width:479px;" class="img-responsive">
    <div style="width:100%; background-color:#475664; display:block; height:32px; text-align:center"> <img src="menu_sml.png" data-toggle="collapse" data-target="#menu"> </div>
  </div>
</div>
